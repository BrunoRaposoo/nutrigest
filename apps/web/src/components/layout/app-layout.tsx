...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-secondary dark:bg-surface-dark flex transition-theme">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-navy-800 border-r border-gray-200 dark:border-gray-800 transform transition-theme lg:translate-x-0 lg:static lg:z-auto',
