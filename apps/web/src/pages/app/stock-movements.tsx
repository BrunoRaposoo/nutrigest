          ...
          <CardHeader>
            ...
            <div className="flex gap-2 flex-wrap">
              <select
                ...
                className="px-3 py-1.5 text-sm border rounded-lg bg-white dark:bg-navy-800 dark:border-gray-700"
              >
              ...
              <input
                ...
                placeholder="Quarto"
                className="w-20 px-3 py-1.5 text-sm border rounded-lg bg-white dark:bg-navy-800 dark:border-gray-700"
              />
            </div>
          </CardHeader>
